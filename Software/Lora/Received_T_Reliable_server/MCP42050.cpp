...
/*
 *  x: resistance value received from client
 */
...
void setPotWiper(int addr, int pos) {
  // add function to limit the pos to 170 (30k) for 50k pot
  // add function to limit the pos to 80 (30k) for 1000k pot
  if (pos > 80) {
  ...
  // add function to limit the pos to 170
